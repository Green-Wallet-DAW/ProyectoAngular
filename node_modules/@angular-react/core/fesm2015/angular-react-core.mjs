...
import { Injectable, RendererStyleFlags2, NgModule, TemplateRef, ComponentRef, Directive, Input, ɵNG_COMP_DEF } from '@angular/core';
...
function createReactContentElement(children, additionalProps) {
    return React.createElement(ReactContent, Object.assign(Object.assign({}, additionalProps), { [CHILDREN_TO_APPEND_PROP]: children }));
}
/**
 ...
 */
class Disguise extends React.PureComponent {
    render() {
    ...
    _renderReactContentChildren() {
        ...
        const renderedChildren = ngChildComponents.map((child, index) => {
            ...
            return React.createElement(disguiseChildrenAs, Object.assign(Object.assign({}, propsToPass), { key: index, ref: childReactElement => {
    ...
    _renderChildrenNaive() {
        ...
        const renderedChildren = React.Children.map(children, child => {
            ...
            return React.createElement(ChildRoot, Object.assign(Object.assign({}, child.props), { key: child.key }), child);
        });
        return renderedChildren;
    }
}
...
function isKnownComponent(elementName) {
...
const setAngularReactMetadata = (componentDef, metadata) => {
    if (componentDef.data) {
        componentDef.data[KEY] = metadata;
    }
};
const getAngularReactMetadata = (type) => {
    var _a;
    return (_a = type === null || type === void 0 ? void 0 : type.data) === null || _a === void 0 ? void 0 : _a[KEY];
};
const isAngularReactComponent = (type) => {
    var _a;
    return ((_a = type === null || type === void 0 ? void 0 : type.data) === null || _a === void 0 ? void 0 : _a[KEY]) != null;
};

// Copyright (c) Microsoft Corporation. All rights reserved.
const DEBUG$1 = false;
class AngularReactRendererFactory extends ɵDomRendererFactory2 {
    ...
    createRenderer(element, type) {
        var _a;
        if (((_a = type.styles) === null || _a === void 0 ? void 0 : _a[0]) === 'react-renderer' || isAngularReactComponent(type)) {
...
// Copyright (c) Microsoft Corporation. All rights reserved.
class AngularReactBrowserModule {
}
/** @nocollapse */ AngularReactBrowserModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: AngularReactBrowserModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
/** @nocollapse */ AngularReactBrowserModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: AngularReactBrowserModule, imports: [BrowserModule], exports: [BrowserModule] });
/** @nocollapse */ AngularReactBrowserModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: AngularReactBrowserModule, providers: [{ provide: ɵDomRendererFactory2, useClass: AngularReactRendererFactory }], imports: [[BrowserModule], BrowserModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: AngularReactBrowserModule, decorators: [{
            type: NgModule,
            args: [{
...
class ReactWrapperComponent {
    ...
    _passAttributesAsProps() {
        ...
        const props = whitelistedHostAttributes.reduce((acc, attr) => (Object.assign(Object.assign({}, acc), { [attr.name]: attr.value })), {});
        const eventListeners = (_b = (_a = this.elementRef.nativeElement).getEventListeners) === null || _b === void 0 ? void 0 : _b.call(_a);
        ...
        this.reactNodeRef.nativeElement.setProperties(Object.assign(Object.assign({}, props), eventHandlersProps));
    }
    _setHostDisplay() {
...
function AngularReact(metadata) {
    return (componentType) => {
        Promise.resolve().then(() => {
            ...
            setAngularReactMetadata(componentDef, metadata !== null && metadata !== void 0 ? metadata : {});
        });
        return componentType;
    };
}
...
export { AngularReact, AngularReactBrowserModule, Disguise, ReactContent, ReactTemplate, ReactWrapperComponent, createReactContentElement, createReactTemplateElement, getPassProps, passProp, registerElement };
//# sourceMappingURL=angular-react-core.mjs.map
