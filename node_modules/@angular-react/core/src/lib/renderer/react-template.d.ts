 ...
 */
export declare function createReactTemplateElement<TContext extends object | void>(templateRef: TemplateRef<TContext>, context: TContext, ngZone: NgZone, additionalProps?: ReactTemplateProps): React.CElement<InternalReactTemplateProps<void | object>, ReactTemplate<void | object>>;
/**
 * @internal
 */
