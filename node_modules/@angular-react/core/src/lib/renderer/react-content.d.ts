 ...
 */
export declare function createReactContentElement(children: ReadonlyArray<HTMLElement>, additionalProps?: ReactContentProps): React.CElement<InternalReactContentProps, ReactContent>;
/**
 * @internal
 */
