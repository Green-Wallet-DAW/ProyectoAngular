 ...
 */
export declare class Disguise extends React.PureComponent<DisguiseProps> {
    render(): React.ReactElement<any, string | React.JSXElementConstructor<any>> | React.FunctionComponentElement<{
        key: string | number;
    }>;
