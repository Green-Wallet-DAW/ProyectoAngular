export declare const passPropsSymbol: unique symbol;
 ...
 */
export declare function passProp(): PropertyDecorator;
export declare function passProp(propName: string): PropertyDecorator;
export declare function getPassProps<T extends object>(obj: T): PassProp[];
