/// <reference types="libs/core/src/lib/@types/geteventlisteners" />
...
export declare abstract class ReactWrapperComponent<TProps extends {}> implements AfterContentInit, AfterViewInit, OnChanges {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<ReactWrapperComponent<any>, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<ReactWrapperComponent<any>, never, never, { "contentClass": "contentClass"; "contentStyle": "contentStyle"; }, {}, never>;
}
